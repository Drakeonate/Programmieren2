...
public class EmailMain {
	...
	public static void main(String[] args) {
		...
		emails[17] = new Email("Bier brauen", "Hey Niko,\nMara will mal Bier brauen, du musst dann wohl unter übel vorbei kommen zum kosten.\nBis denne\nSteve");
		emails[18] = new Email("Friday4Future", "Hey Laura,\nwollen wir mal Werbung für Friday4Future machen? Können ja mal nachher drüber quatschen. Wann treffen wir uns eigentlich?\nSee u later Aligator");
		emails[19] = new Email("Bla", "Test, bla, test, huhu, was geht, was geht");
